...
export const addTimeline = async (req, res) => {
    try {
       ...
       res.status(200).json({
          success:true,
          message:"Added To Timeline Succcessfully",
       })
    } catch (error) {
        return res.status(400).json({
            success: false,
...
export const addProjects = async (req, res) => {
    try {
       ...
       res.status(200).json({
          success:true,
          message:"Added To Projects Succcessfully",
       })
    } catch (error) {
        return res.status(400).json({
            success: false,
...
export const deleteTimeline = async (req, res) => {
    try {
       ...
       res.status(200).json({
          success:true,
          message:"Deleted from Timeline Succcessfully",
       })
    } catch (error) {
        return res.status(400).json({
            success: false,
...
export const deleteProjects = async (req, res) => {
    try {
       ...
       res.status(200).json({
          success:true,
          message:"Deleted from Projects Succcessfully",
       })
    } catch (error) {
        return res.status(400).json({
            success: false,
